        ...
        <Form id="donate-form" horizontal>
          <Row className="show-grid">
            ...
            <Col componentClass={ControlLabel} md={1}>
              <ControlLabel className="size18-bolder pull-left">
                Type
              </ControlLabel>
            </Col>
          ...
          <Row className="show-grid">
            ...
            <Col componentClass={ControlLabel} md={7}>
              <div id="tags">
                <Row className="show-grid">
                  <Col componentClass={ControlLabel} md={2}>
                    <ControlLabel className="size14-bolder pull-left">
                      Category
                    </ControlLabel>
                  </Col>
              ...
              <Row className="show-grid">
                <Col componentClass={ControlLabel} md={2} />
                <Col componentClass={ControlLabel} md={8}>
                  <ControlLabel id="pickup-location-title">
          ...
          <Row className="show-grid">
            <Col id="address" componentClass={ControlLabel} md={3}>
              ...
              <Row className="show-grid">
                <Col componentClass={ControlLabel} md={12}>
                  <ControlLabel
                    className="size14-bolder pull-left"
                    id="address-title"
                  >
                    Pickup Address
                  </ControlLabel>
              ...
              <Row className="show-grid">
                <Col componentClass={ControlLabel} md={12}>
                  ...
                  <FormControl
                    ...
                    onChange={this.handleInputChange}
                  />
                  <ControlLabel id="size18-bolder" className="pull-left">
                    -
                  </ControlLabel>
                  <FormControl
                    className="pull-left"
            ...
            <Col componentClass={ControlLabel} md={5}>
              <Row className="info show-grid">
                <Col
                  className="zero-right-pad zero-top-pad"
                  componentClass={ControlLabel}
                  md={4}
                >
                  <Row className="show-grid">
                    <Col
                      className="zero-right-pad zero-left-pad zero-top-pad"
                      componentClass={ControlLabel}
                      md={12}
                    >
                ...
                <Col componentClass={ControlLabel} md={8}>
                  <FormControl
                    className="zero-right-pad zero-left-pad pull-left"
                    componentClass="textarea"
                    id="donor-comments-input"
              ...
              <Row className="show-grid">
                <Checkbox
                  className="size14-bolder pull-left"
                  id="donor-pickup-confirmed"
                  name="donorPickupConfirmed"
                  onChange={this.handleInputChange}
                  inline
                >
              ...
              <Row className="info show-grid">
                ...
                <Col componentClass={ControlLabel} md={8}>
                  <FormControl
                    className="zero-right-pad zero-left-pad pull-left"
                    componentClass="textarea"
                    id="donee-comments-input"
                    name="doneePickupComments"
                    onChange={this.handleInputChange}
                  />
                </Col>
              </Row>
              <Row className="show-grid">
                <Checkbox
                  className="size14-bolder pull-left"
                  id="donee-pickup-confirmed"
                  name="doneePickupConfirmed"
                  onChange={this.handleInputChange}
                  inline
                >
                  Donee Pickup Confirmed
                </Checkbox>
                <ControlLabel
                  id="donee-pickup-time-label"
                  className="pull-left"
                >
                  Time:
                </ControlLabel>
                <FormControl
                  className="pull-left"
                  type="text"
                  id="donee-pickup-time"
                  name="type"
                  placeholder="0:00"
                  name="doneePickupTime"
                  onChange={this.handleInputChange}
                />
                <Radio
                  className="am-pm pull-left"
          ...
          <Row className="show-grid">
            <Col componentClass={ControlLabel} md={8}>
              <Button
                className="CRUD-buttons pull-left"
